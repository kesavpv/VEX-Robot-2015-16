...
#pragma config(Motor,  port2,           rightBack,     tmotorVex393HighSpeed_MC29, PIDControl, reversed, encoderPort, I2C_1)
...
#pragma config(Motor,  port8,           leftBack,      tmotorVex393HighSpeed_MC29, PIDControl, encoderPort, I2C_2)
